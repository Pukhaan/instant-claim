// /home — bunq-style home screen, the entry point to the claim flow.
// Mirrors the "01 - home" frame from the Finn-Insurance Figma 1:1 with real
// data from the seeded bunq sandbox: live balance, real account, real recent
// transactions. Tap "Start a Claim" to launch /claim.
